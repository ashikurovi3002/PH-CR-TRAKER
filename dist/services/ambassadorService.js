...
class AmbassadorService {
    ...
    static async getRedeems(userId) {
    ...
    static async requestRedeem(userId, rewardId) {
    ...
    static async getLeaderboard(userId, type) {
    ...
    // Feedback
    static async submitFeedback(userId, message, rating) {
